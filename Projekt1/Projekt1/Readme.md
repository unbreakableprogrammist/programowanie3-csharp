...
![img_1.png](img_1.png)
Powyżej przykład, dwa zdjęcia z dwóch dat z dwóch lokalizacji.
---
...
* Dodałem zabezpieczenie,że jeśli odczytana data jest wcześniejsza niż rok 1970, program uznaje to za błąd i pobiera datę bieżącą.

### 2. Kropka vs Przecinek w GPS 

**Problem:** Mój system jest po polsku, więc double jest z przecinkiem (np. `52,22`). API Nominatim wymaga kropki (`52.22`). Przez to zapytania URL były błędne i geolokalizacja nie działała.
**Rozwiązanie:**
